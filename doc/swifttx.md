...
This mechanism has been integrated into Bitcore-Node-GRINC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GRINC-Developer/insight-api-GRINC#web-socket-api](https://github.com/GRINC-Developer/insight-api-GRINC#web-socket-api)
* API: [https://github.com/GRINC-Developer/insight-api-GRINC#swifttx-transactions](https://github.com/GRINC-Developer/insight-api-GRINC#swifttx-transactions)
...
By default, the GRINC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GRINC Core daemon:
