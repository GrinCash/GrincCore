...
In order to support loading of multiple wallets in GRINC-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is GRINC.cpp.
...
Changes to GRINC.cpp
----------------------
GRINC.cpp is the entry point into GRINC-qt, and as such, will require some minor modifications to provide hooks for
