...
#   c) node1 mines 32 blocks, so now node 0 has 60001GRINC, node 1 has 4250GRINC, node2 has none.
#   d) node0 sends 601 GRINC to node2, in two transactions (301 GRINC, then 300 GRINC).
