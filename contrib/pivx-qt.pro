...
RESOURCES += src/qt/GRINC.qrc src/qt/GRINC_locale.qrc

TRANSLATIONS += src/qt/locale/GRINC_bg.ts \
                src/qt/locale/GRINC_de.ts \
                src/qt/locale/GRINC_en.ts \
                src/qt/locale/GRINC_es.ts \
                src/qt/locale/GRINC_fi.ts \
                src/qt/locale/GRINC_fr.ts \
                src/qt/locale/GRINC_it.ts \
                src/qt/locale/GRINC_ja.ts \
                src/qt/locale/GRINC_pl.ts \
                src/qt/locale/GRINC_pt.ts \
                src/qt/locale/GRINC_ru.ts \
                src/qt/locale/GRINC_sk.ts \
                src/qt/locale/GRINC_sv.ts \
                src/qt/locale/GRINC_vi.ts \
                src/qt/locale/GRINC_zh_CN.ts \
                src/qt/locale/GRINC_zh_TW.ts
