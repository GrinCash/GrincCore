...
bool CheckProofOfStake(const CBlock block, uint256& hashProofOfStake, std::unique_ptr<CStakeInput>& stake)
{
    ...
    if (tx.IsZerocoinSpend()) {
        ...
        stake = std::unique_ptr<CStakeInput>(new CZGRINCStake(spend));
    } else {
        ...
        CGRINCStake* GRINCInput = new CGRINCStake();
        GRINCInput->SetInput(txPrev, txin.prevout.n);
        stake = std::unique_ptr<CStakeInput>(GRINCInput);
    }
