...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GRINC Core GRINC-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  GRINC-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded GRINC transaction") + "\n" +
                               "  GRINC-tx [options] -create [commands]   " + _("Create hex-encoded GRINC transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded GRINC transaction
