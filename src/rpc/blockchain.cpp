...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in GRINC\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zGRINCsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zGRINC denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zGRINC denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zGRINC denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zGRINC denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zGRINC denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zGRINC denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zGRINC denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zGRINC denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zGRINC denominations\n"
            "  }\n"
            "}\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of GRINC addresses\n"
            "     \"GRINCaddress\"   	 	(string) GRINC address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
