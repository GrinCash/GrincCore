...
extern UniValue setzGRINCseed(const UniValue& params, bool fHelp);
extern UniValue getzGRINCseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzGRINC(const UniValue& params, bool fHelp);
extern UniValue dzGRINCstate(const UniValue& params, bool fHelp);
