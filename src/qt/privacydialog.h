...
public:
    ...
    void setZGRINCControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzGRINC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzGRINC_clicked();
    void on_pushButtonZGRINCControl_clicked();
