                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzGRINCPathCustom = GetArg("-zGRINCbackuppath", "");
    ...
    if(!strzGRINCPathCustom.empty()) {
        ui->wallet_customzGRINCbackuppath->setText(QString::fromStdString(strzGRINCPathCustom));
        ui->wallet_customzGRINCbackuppath_label->setVisible(true);
        ui->wallet_customzGRINCbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzGRINCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the GRINC RPC console.") + "<br>" +
