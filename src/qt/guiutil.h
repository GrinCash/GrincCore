...
/** Utility functions used by the GRINC Qt UI.
 */
namespace GUIUtil
{
...
// Render GRINC addresses in monospace font
...
// Parse "GRINC:" URI into recipient object, return true on successful parsing
