...
/* GRINC GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GRINC"
#define QAPP_ORG_DOMAIN "GRINC.me"
#define QAPP_APP_NAME_DEFAULT "GRINC-Qt"
#define QAPP_APP_NAME_TESTNET "GRINC-Qt-testnet"
