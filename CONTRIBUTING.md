Contributing to GRINC Core
============================

The GRINC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GRINC Core project, and is not to be
confused with overall GRINC Network Protocol consensus changes.

Whether a pull request is merged into GRINC Core rests with the project merge
...
Patches that change GRINC consensus rules are considerably more involved than
...
Where a patch set proposes to change the GRINC consensus, it must have been
...
The project leader is the release manager for each GRINC Core release.
